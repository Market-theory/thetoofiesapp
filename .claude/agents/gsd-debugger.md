...
<required_reading>
@/home/user/toofies/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/toofies/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/toofies/.claude
                  → checks /home/user/toofies/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/toofies/.claude/gsd-core
                  → writes to /home/user/toofies/.claude/gsd-core/hooks/
...
@/home/user/toofies/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/toofies/.claude/gsd-core/references/common-bug-patterns.md

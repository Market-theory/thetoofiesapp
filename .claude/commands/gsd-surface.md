...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/toofies/.claude/.gsd-surface.json`
(sibling to `/home/user/toofies/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/toofies/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/toofies/.claude/skills`).
...
`/home/user/toofies/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/toofies/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/toofies/.claude/.gsd-surface.json`
Install profile marker: `/home/user/toofies/.claude/.gsd-profile`
Skill dirs: `/home/user/toofies/.claude/skills/gsd-*/`
Engine module: `/home/user/toofies/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/toofies/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>

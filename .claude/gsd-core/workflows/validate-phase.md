...
```
Agent(
  prompt="Read /home/user/toofies/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/toofies/.claude/gsd-core/templates/VALIDATION.md`

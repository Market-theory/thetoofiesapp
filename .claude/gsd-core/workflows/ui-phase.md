...
```markdown
Read /home/user/toofies/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/toofies/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/toofies/.claude/agents/gsd-ui-checker.md for instructions.
